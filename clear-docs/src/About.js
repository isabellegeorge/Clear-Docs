    ...
    <div className="flex w-screen justify-center items-center h-auto">
      <div className='flex flex-col gap-1 p-8'>
        ...
        <section id="how-it-works" aria-labelledby="how-it-works-heading">
          ...
          <h3 className="text-lg font-bold italic leading-7">What is OCR?</h3>
          ...
          <h3 className="text-lg font-bold italic leading-7">How does it work?</h3>
        ...
        <section id="equity" aria-labelledby="equity-heading">
          <h2 id="equity-heading" className="text-2xl font-bold mt-8 mb-4">Equity</h2>
          <h3 className="text-lg font-bold italic leading-7">Equity is important to us!</h3>
        ...
        <figure aria-labelledby="inclusion-heading">
